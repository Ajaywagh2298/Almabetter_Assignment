...
console.log("Enter a number to print all even numbers upto and including it");
let n = prompt("Number: ");
...
console.log("Enter the size of the first array");
let n1 = prompt("Size: ");
console.log("Enter the elements of the first array");
let arr1 = [];
for (let i = 0; i < n1; i++) {
    arr1.push(prompt("Element: "));
}
console.log("Enter the size of the second array");
let m1 = prompt("Size: ");
console.log("Enter the elements of the second array");
let arr2 = [];
for (let i = 0; i < m1; i++) {
    arr2.push(prompt("Element: "));
}
console.log(`Answer is : ${sumOfTwoArrays(arr1, arr2)}`);
...
console.log("Enter a string to reverse it");
