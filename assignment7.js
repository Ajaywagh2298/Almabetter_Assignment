...
/*
Increasing Counter
Given a number n from which counter start as count , write a Javascript program that increments the count after every 2 seconds by 2 and stops incrementing when the count reaches 10.
Example 1:
Input:
n = 0
Output:
